    ...
    try {
        ...
        htmlConteudo += `
            ...
            <div class="mt-3">
                ...
                <p><strong>Renda Mensal:</strong> ${(_a = formulario.rendaMensal) !== null && _a !== void 0 ? _a : ''}</p>
                <p><strong>Nº de Moradores:</strong> ${(_b = formulario.numeroMoradores) !== null && _b !== void 0 ? _b : ''}</p>
            </div>
        `;
        htmlConteudo += `</div>`;
        return htmlConteudo;
