...
(function() {
    ...
    if (menuHamburguer) {
        menuHamburguer.addEventListener("click", (e: Event) => {
            e.preventDefault();
            e.stopPropagation();
            ...
            if (menuLateral && menuSobreposicao) {
                ...
                (e.currentTarget as HTMLElement).classList.toggle("ativo");
            } else {
...
const notificationIcon = document.querySelector<HTMLElement>(".notification-icon");
const notificationPanel = document.querySelector<HTMLElement>(".notification-panel");
const notificationsCloseBtn = document.querySelector<HTMLElement>(".botao-fechar-notificacoes");
const markAsReadBtn = document.querySelector<HTMLElement>(".botao-marcar-lidas");
const mainContent = document.querySelector<HTMLElement>(".main-content");
const formSteps = document.querySelectorAll<HTMLElement>(".etapa-formulario");
const form = document.getElementById("formularioAdocao") as HTMLFormElement | null;
const requiredInputs = document.querySelectorAll<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>("input[required], textarea[required], select[required]");
const submitButton = document.querySelector<HTMLButtonElement>(".botao-enviar");
const cancelButton = document.querySelector<HTMLButtonElement>(".botao-voltar");
...
const maskMoneyOptions: MaskMoneyOptions = {
    precision: 2,
    separator: ',',
    delimiter: '.',
    unit: 'R$ '
...
function abrirPainelNotificacoes(event: Event): void {
...
function fecharPainelNotificacoes(): void {
...
function inicializarCampos(): void {
...
function animarFormulario(): void {
...
function marcarErro(input: HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement, mensagem: string): void {
...
function limparErro(input: HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement): void {
...
function exibirModalConfirmacao(): void {
...
async function enviarFormulario(event: Event): Promise<boolean> {
    event.preventDefault();
...
async function manipularEnvio(event: Event): Promise<boolean> {
...
function exibirModalManualmente(): void {
    const modal = document.getElementById("modalConfirmacao") as HTMLElement | null;
...
function garantirVisibilidadeFormulario(): void {
...
function inicializarNavegacaoPainel(): void {
...
function verificarParametrosUrl(): void {
